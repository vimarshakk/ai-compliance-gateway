...
The core engine is fully open source. Enterprise features (SSO/SAML, advanced governance, managed cloud) are available in [ACG Enterprise](https://github.com/vimarshakk/ai-compliance-gateway/enterprise).
