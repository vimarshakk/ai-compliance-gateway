...
1. **Email**: Send a detailed report to [security@acg.dev](mailto:security@acg.dev)
...
- **Security Team**: [security@acg.dev](mailto:security@acg.dev)
- **General Inquiries**: [hello@acg.dev](mailto:hello@acg.dev)
